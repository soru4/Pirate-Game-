...
public class OceanAdvanced : MonoBehaviour
{
  ...
  const int NB_WAVE = 3;
  const int NB_INTERACTIONS = 2;
  static Wave[] waves =
  {
    new Wave(99, 1.0f, 1.4f, 0.9f, new Vector2(new System.Random().Next(-3, 4), new System.Random().Next(-3, 4)).normalized),
    new Wave(60, 1.2f, 0.8f, 0.5f, new Vector2(new System.Random().Next(-3, 4), new System.Random().Next(-3, 4)).normalized),
    new Wave(20, 3.5f, 0.4f, 0.8f, new Vector2(new System.Random().Next(-3, 4), new System.Random().Next(-3, 4)).normalized),
    new Wave(30, 2.0f, 0.4f, 0.4f, new Vector2(new System.Random().Next(-3, 4), new System.Random().Next(-3, 4)).normalized),
